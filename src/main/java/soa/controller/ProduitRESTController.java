...
public class ProduitRESTController {
    ...
    @GetMapping(
    	       value = "/par-categorie/{categorieId}",
    	       produces = { MediaType.APPLICATION_JSON_VALUE }
    	)
    	public List<Produit> getProduitsParCategorie(@PathVariable Long categorieId) {
    	    // Utilisez votre repository pour obtenir les produits par catégorie
    	    List<Produit> produits = produitRepos.findByCategorieId(categorieId);
